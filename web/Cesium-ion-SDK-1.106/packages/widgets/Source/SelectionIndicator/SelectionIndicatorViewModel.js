...
function SelectionIndicatorViewModel(
  ...
  knockout.defineProperty(this, "_transform0", {
    get: function () {
      return `rotate(${this._rotation}) translate(0,${-this._distance})`;
    },
  });
  knockout.defineProperty(this, "_transform1", {
    get: function () {
      return `rotate(${this._rotation + 90}) translate(0,${-this._distance})`;
    },
  });
  knockout.defineProperty(this, "_transform2", {
    get: function () {
      return `rotate(${this._rotation + 180}) translate(0,${-this._distance})`;
    },
  });
  knockout.defineProperty(this, "_transform3", {
    get: function () {
      return `rotate(${this._rotation + 270}) translate(0,${-this._distance})`;
    },
  });
...
SelectionIndicatorViewModel.prototype.animateAppear = function () {
  ...
  this._tweens.add({
    ...
    update: function (value) {
      viewModel._distance = value.distance;
      viewModel._rotation = value.rotation;
    },
  });
};
...
SelectionIndicatorViewModel.prototype.animateDepart = function () {
  ...
  this._tweens.add({
    startObject: {
      distance: viewModel._distance,
      rotation: viewModel._rotation,
    },
    stopObject: {
      distance: 60,
      rotation: 25,
