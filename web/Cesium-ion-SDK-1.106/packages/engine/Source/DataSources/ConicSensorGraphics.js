...
ConicSensorGraphics.prototype.merge = function (source) {
  ...
  this.showViewshed = defaultValue(this.showViewshed, source.showViewshed);
  this.viewshedVisibleColor = defaultValue(
    this.viewshedVisibleColor,
    source.viewshedVisibleColor
  );
  this.viewshedOccludedColor = defaultValue(
    this.viewshedOccludedColor,
    source.viewshedOccludedColor
  );
  this.viewshedResolution = defaultValue(
    this.viewshedResolution,
    source.viewshedResolution
  );
