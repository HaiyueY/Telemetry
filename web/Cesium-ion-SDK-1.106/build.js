...
const workspaceSourceFiles = {
  ...
  "ion-sdk-widgets": ["packages/ion-sdk-widgets/Source/**/*.js"],
};
...
const workspaceSpecFiles = {
  ...
  "ion-sdk-widgets": ["packages/ion-sdk-widgets/Specs/**/*Spec.js"],
};
...
const workspaceCssFiles = {
  ...
  "ion-sdk-widgets": ["packages/ion-sdk-widgets/Source/**/*.css"],
};
...
/**
 * Builds a workspace, including creating and entry point and spec files
 *
 * @param {object} options
 * @param {boolean} [options.incremental=false] True if builds should be generated incrementally.
 * @param {boolean} [options.write=true] True if bundles generated are written to files instead of in-memory buffers.
...
export const buildWorkspace = async (workspace, options) => {
  ...
  mkdirp.sync(`packages/${workspace}/Build`);
...
export async function buildCesium(options) {
  ...
  await bundleCSS({
    filePaths: workspaceCssFiles[`ion-sdk-widgets`],
    outdir: path.join(outputDirectory, "Widgets"),
    outbase: "packages/ion-sdk-widgets/Source",
  });
  ...
  await copyFiles(
    ["packages/ion-sdk-widgets/Source/**/*.css"],
    "Source/Widgets",
    "packages/ion-sdk-widgets/Source"
  );
